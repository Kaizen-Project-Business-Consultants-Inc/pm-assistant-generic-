...
- **Gantt click-to-select then edit** — first click selects a row, second click enters inline edit (matches MS Project); Tab/Shift+Tab indent/outdent works on selected rows without needing cell focus
