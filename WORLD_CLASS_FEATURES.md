...
| Viewer Assignment-Based Permissions Phase 2 (extends viewer bypass to 5 areas: task update/comment for assigned tasks via resource linkage, meeting action item update/complete/reopen/cancel for assigned items, file attachment upload to assigned tasks/RAID items, My Assignments dashboard endpoint, My Assignments widget with collapsible Tasks/RAID/Action Items sections) | Done | Enhancement |
