...
- **Narrative summary panel**: plain-English project health paragraph — "The project is X% complete with Y% of budget spent. It is [schedule status] and [cost status]. [Forecast sentence]." — with an On Track / Needs Attention / At Risk badge and a % Complete vs % Spent comparison bar (blue = complete, green/red = spent)
