...
| Gantt Quick-Assign (POST /resources/quick-assign with taskId+resourceId; derives dates from task, defaults hours from capacity; advisory over-allocation warning; "+" button on Gantt unassigned rows) | Done | Enhancement |
