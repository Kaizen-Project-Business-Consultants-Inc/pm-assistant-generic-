...
- **Dashboard as default landing page** — authenticated users land on the Dashboard with the Morning Briefing widget, which covers overdue tasks, due-today/this-week items, high risks, pending change requests, budget alerts, and upcoming milestones in a single collapsible panel
...
| Dashboard as default landing page — Morning Briefing widget covers overdue tasks, due-today/this-week items, high risks, pending change requests, budget alerts, upcoming milestones; replaces former My Work page (removed — functionality consolidated into Dashboard briefing) | Done | UX |
