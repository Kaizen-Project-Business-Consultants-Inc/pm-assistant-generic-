...
| Project Brief Card (inline-editable markdown description on Overview tab; click-to-edit with auto-save 1.5s debounce; headings/bold/italic/lists/links/inline code rendering; empty-state placeholder; DOMPurify sanitization; shared `renderMarkdown` utility extracted from QueryPage) | Done | Enhancement |
