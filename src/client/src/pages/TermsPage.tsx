    ...
    <div className="min-h-screen bg-white dark:bg-gray-800">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose max-w-none text-sm text-gray-600 dark:text-gray-300 space-y-6">
          ...
          <p><strong>Refunds:</strong> Monthly subscriptions are non-refundable. Annual subscriptions may be refunded on a pro-rated basis if requested within 30 days of the billing date. After 30 days, annual subscriptions are non-refundable. To request a refund, contact {SUPPORT_EMAIL}.</p>
          ...
          <div className="mt-8 rounded-lg border-2 border-amber-400 dark:border-amber-500 bg-amber-50 dark:bg-amber-900/20 p-5">
            ...
            <div className="mt-3 space-y-3 text-sm text-amber-900 dark:text-amber-200">
              <p><strong>Monthly Token Allowances.</strong> AI token budgets vary by subscription tier. <strong>Consultant Basic</strong> does not include AI features. <strong>Consultant Pro</strong> includes 500,000 tokens per month. Free trial accounts receive 25,000 tokens for the duration of the trial. Paid tier token budgets reset on the first day of each calendar month (UTC). Current allowances for all tiers are listed on the <a href="/pricing" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:text-primary-300 underline">pricing page</a>.</p>
