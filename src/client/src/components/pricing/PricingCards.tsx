...
const FALLBACK_PLANS: PlanDef[] = [
  {
    ...
    annual: 0,
    tokens: '—',
    tokensEquiv: 'Sample AI previews only',
    storage: '100MB',
    viewerInvites: '0',
    features: [
      'Up to 3 projects',
      '14-day full access (Pro features)',
      'Sample AI previews (no live AI)',
...
export const COMPARISON: FeatureRow[] = [
  ...
  { feature: 'AI tokens/month', desc: 'Monthly budget for AI-powered features', trial: '—', consultant_basic: '—', consultant_pro: '500K', sme: '500K/seat' },
