...
export const COMPARISON: FeatureRow[] = [
  ...
  { feature: 'Resource Management & Heatmaps', desc: 'Capacity planning with visual workload and allocation heatmaps', trial: true, consultant_basic: true, consultant_pro: true, sme: true },
  { feature: 'Custom Report Builder', desc: 'Generate tailored status reports with AI assistance', trial: true, consultant_basic: true, consultant_pro: true, sme: true },
            ...
            >
              ...
              <div className="mb-6">
                {isCurrent ? (
                  ...
                  <a
                    href="#waitlist"
                    className={`block w-full py-2.5 px-4 text-sm font-semibold rounded-lg text-center transition-colors ${dk ? 'bg-primary-700 text-white hover:bg-primary-800' : 'bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100'}`}
                  >
                  ...
                  <Link
                    ...
                    className={`block w-full py-2.5 px-4 text-sm font-semibold rounded-lg text-center transition-colors ${
                      plan.highlight
                        ...
                        : dk ? 'bg-primary-700 text-white hover:bg-primary-800' : 'bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100'
                    }`}
                  >
                    Subscribe
                  </Link>
      ...
      {mode !== 'waitlist' && <div className="max-w-xl mx-auto mt-16">
        <div className="bg-amber-900/20 border border-amber-700 rounded-2xl p-6 text-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold rounded-lg bg-amber-700 text-white hover:bg-amber-800 transition-colors disabled:opacity-50"
          >
            {topUpLoading ? (
              <>
