          ...
          {views.length > 0 && (
            <div className="px-1 mb-1">
              <div className="px-2 py-1">
                <span className="text-xs font-semibold text-gray-500 dark:text-gray-500 uppercase tracking-wider">Saved Views</span>
              </div>
              {views.map(view => (
                <div
                  key={view.id}
                ...
                >
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-500">{view.columns.length} cols</span>
                  <button
