              ...
              {steps.length === 0 ? (
                ...
                <div className="space-y-2">
                  {steps.map((step, index) => (
                    ...
                    >
                      {/* Order indicator */}
                      <span className="text-xs font-bold text-gray-500 w-6 text-center flex-shrink-0">
                        {step.stepOrder}
                      </span>
                      ...
                      <div className="flex flex-col gap-0.5 flex-shrink-0">
                        <button
                          ...
                          disabled={index === 0}
                          className="p-0.5 text-gray-500 hover:text-primary-600 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                          title="Move up"
