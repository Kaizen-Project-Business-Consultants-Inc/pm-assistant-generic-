...
const pmoSupport: ProjectTemplate = {
  ...
  tasks: [
    ...
    { refId: 'run-m1', name: 'Month 1 — reporting and controls', description: 'Weekly report, monthly steering committee, RAID and change log kept current', estimatedDays: 20, priority: 'high', parentRefId: 'run', dependencyRefId: 'gate1', dependencyType: 'FS', offsetDays: 0, skills: ['project-management'], isSummary: false, mandatory: true },
