...
const pmoSupport: ProjectTemplate = {
  ...
  tasks: [
    ...
    // The cadence runs as monthly periods rather than one long bar.
    //
    // It used to be two tasks of 140 days each, running side by side. That is poor
    // practice whoever writes it: asking whether a 140-day task is 40% done tells you
    // nothing, and nothing downstream moves when it slips. Seven monthly periods, each
    // following the last, give a checkpoint every month — which is the point of being the
    // PM. Our own schedule review flagged the original, correctly.
    { refId: 'run', name: 'Run the delivery cadence', description: 'The engagement itself, period by period: report, control, escalate, decide', estimatedDays: 140, priority: 'high', parentRefId: null, dependencyRefId: 'gate1', dependencyType: 'FS', offsetDays: 0, skills: [], isSummary: true, mandatory: true },
    { refId: 'run-m1', name: 'Month 1 — reporting and controls', description: 'Weekly report, monthly steering committee, RAID and change log kept current', estimatedDays: 20, priority: 'high', parentRefId: 'run', dependencyRefId: 'est-raid', dependencyType: 'FS', offsetDays: 0, skills: ['project-management'], isSummary: false, mandatory: true },
    { refId: 'run-m2', name: 'Month 2 — reporting and controls', description: 'Weekly report, monthly steering committee, RAID and change log kept current', estimatedDays: 20, priority: 'high', parentRefId: 'run', dependencyRefId: 'run-m1', dependencyType: 'FS', offsetDays: 0, skills: ['project-management'], isSummary: false, mandatory: true },
    { refId: 'run-m3', name: 'Month 3 — reporting and controls', description: 'Weekly report, monthly steering committee, RAID and change log kept current', estimatedDays: 20, priority: 'high', parentRefId: 'run', dependencyRefId: 'run-m2', dependencyType: 'FS', offsetDays: 0, skills: ['project-management'], isSummary: false, mandatory: true },
    { refId: 'run-mid', name: 'Mid-point health check and re-baseline if needed', description: 'An honest look at whether the plan still reflects reality. Easier now than in month six.', estimatedDays: 10, priority: 'high', parentRefId: 'run', dependencyRefId: 'run-m3', dependencyType: 'FS', offsetDays: 0, skills: ['project-management'], isSummary: false, mandatory: true },
    { refId: 'run-m4', name: 'Month 4 — reporting and controls', description: 'Weekly report, monthly steering committee, RAID and change log kept current', estimatedDays: 20, priority: 'high', parentRefId: 'run', dependencyRefId: 'run-mid', dependencyType: 'FS', offsetDays: 0, skills: ['project-management'], isSummary: false, mandatory: true },
    { refId: 'run-m5', name: 'Month 5 — reporting and controls', description: 'Weekly report, monthly steering committee, RAID and change log kept current', estimatedDays: 20, priority: 'high', parentRefId: 'run', dependencyRefId: 'run-m4', dependencyType: 'FS', offsetDays: 0, skills: ['project-management'], isSummary: false, mandatory: true },
    { refId: 'run-m6', name: 'Month 6 — reporting and controls', description: 'Weekly report, monthly steering committee, RAID and change log kept current', estimatedDays: 20, priority: 'high', parentRefId: 'run', dependencyRefId: 'run-m5', dependencyType: 'FS', offsetDays: 0, skills: ['project-management'], isSummary: false, mandatory: true },
    { refId: 'run-ready', name: 'Delivery accepted, controls ready to hand over', description: 'The point at which the delivery is done and the PM role can wind down', estimatedDays: 1, priority: 'high', parentRefId: 'run', dependencyRefId: 'run-m6', dependencyType: 'FS', offsetDays: 0, skills: [], isSummary: false, isMilestone: true, mandatory: true },
    { refId: 'close', name: 'Closure and handover', description: 'Hand the controls to the client, capture lessons', estimatedDays: 20, priority: 'high', parentRefId: null, dependencyRefId: 'run-ready', dependencyType: 'FS', offsetDays: 0, skills: ['project-management'], isSummary: false, mandatory: true },
