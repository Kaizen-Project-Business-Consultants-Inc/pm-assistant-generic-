...
const systemsImplementation: ProjectTemplate = {
  ...
  tasks: [
    ...
    { refId: 'des-signoff', name: 'Design walkthrough and sign-off', description: 'Walk the client through it before building anything', estimatedDays: 10, priority: 'high', parentRefId: 'des', dependencyRefId: 'des-spec', dependencyType: 'FS', offsetDays: 0, skills: ['business-analysis'], isSummary: false },
    ...
    { refId: 'tst-sit', name: 'System integration testing', description: 'End to end across the integrated systems', estimatedDays: 20, priority: 'high', parentRefId: 'tst', dependencyRefId: 'bld', dependencyType: 'FS', offsetDays: 0, skills: ['testing'], isSummary: false, mandatory: true },
    ...
    { refId: 'tst-uat', name: 'Client user acceptance testing', description: 'The client tests it against their own scripts', estimatedDays: 20, priority: 'urgent', parentRefId: 'tst', dependencyRefId: 'tst-fix', dependencyType: 'FS', offsetDays: 0, skills: ['testing'], isSummary: false, mandatory: true },
    ...
    { refId: 'glv-cut', name: 'Production cutover', description: 'Final data load and switch over', estimatedDays: 5, priority: 'urgent', parentRefId: 'glv', dependencyRefId: 'gate3', dependencyType: 'FS', offsetDays: 5, skills: ['configuration'], isSummary: false, mandatory: true },
