...
const systemsImplementation: ProjectTemplate = {
  ...
  tasks: [
    ...
    { refId: 'tst-sit', name: 'System integration testing', description: 'End to end across the integrated systems', estimatedDays: 20, priority: 'high', parentRefId: 'tst', dependencyRefId: 'bld-integ', dependencyType: 'FS', offsetDays: 0, skills: ['testing'], isSummary: false, mandatory: true },
