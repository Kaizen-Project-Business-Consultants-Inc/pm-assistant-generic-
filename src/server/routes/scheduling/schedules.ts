...
const createTaskSchema = z.object({
  ...
  baselineStartDate: z.string().date().optional().nullable(),
  baselineFinishDate: z.string().date().optional().nullable(),
  baselineDurationDays: z.number().min(0).optional().nullable(),
  baselineCost: z.number().min(0).optional().nullable(),
  ...
  fastify.post('/:scheduleId/tasks', {
    ...
    try {
      ...
      const task = await scheduleService.createTask({
        ...
        baselineStartDate: data.baselineStartDate || undefined,
        baselineFinishDate: data.baselineFinishDate || undefined,
        baselineDurationDays: data.baselineDurationDays ?? undefined,
